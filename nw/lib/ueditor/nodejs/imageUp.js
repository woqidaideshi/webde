...
var url = require('url');
var uploadsPath = path.resolve('imageUp') + '/';//存储图片的路径
var action = {
    /// 上传图片
...
       
module.exports = {
   "get:/imageUp/config": function (req, res) {
        action[req.query.action](req, res);
    },
    "get:/imageUp/uploads": function (req, res) {
        action[req.query.action](req, res);
    },
    "post:/imageUp/uploads": function (req, res) {
        action[req.query.action](req, res);
    }
}