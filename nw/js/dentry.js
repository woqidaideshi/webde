...
var DEntry = Widget.extend({
  ...
  /**
   * [bindEvents bind event to entry]
   * @return {[type]} [description]
   */
  bindEvents: function() {
    var _entry = this;
  ...
  /**
   * [setTabIdx set entry tab index]
   * @param {[type]} tabIdx_ [tab index]
   */
...
var AppEntry = DEntry.extend({
  ...
  /**
   * [attachCtxMenu attach context menu]
   * @return {[type]} [description]
   */
  ...
  /**
   * [rename rename app name]
   * @param  {[type]} newName_ [new name]
   * @return {[type]}          [description]
   */
...
var FileEntry = DEntry.extend({
  ...
  /**
   * [dynamicsMenu dynamics load context menu]
   * @param  {[type]} id_    [description]
   * @param  {[type]} $menu_ [description]
   * @return {[type]}        [description]
   */
